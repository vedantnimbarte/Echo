...
const COLS: { title: string; links: { label: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Write a plugin", href: LINKS.plugins },
  ...
  },
  {
    title: "Docs",
    links: [
      { label: "Wake word", href: LINKS.wakeWord },
      { label: `Release v${VERSION}`, href: LINKS.releaseNotes },
...
export default function Footer() {
  return (
    <footer className="relative mt-28 overflow-hidden border-t border-line sm:mt-40">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.4fr_2fr]">
          <div>
            ...
            <p className="mt-6 max-w-sm text-lg leading-relaxed text-fog">
              A voice keyboard that runs on your own machine. Say the word,
              start talking, and it types.
            </p>
